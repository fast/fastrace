...
[![MSRV 1.81.0](https://img.shields.io/badge/MSRV-1.81.0-green?style=flat-square&logo=rust)](https://www.whatrustisit.com)
...
Fastrace is built against the latest stable release. The minimum supported version is 1.81.0. The current Fastrace version is not guaranteed to build on Rust versions earlier than the minimum supported version.
